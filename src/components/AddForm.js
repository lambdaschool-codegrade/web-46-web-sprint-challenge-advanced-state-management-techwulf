...
import {addSmurf, submitError} from '../actions';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
          props.submitError("Name, position and nickname fields are required.");
        } else {
          props.addSmurf({
            ...state,
            id: Math.random()
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                props.appError && <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {props.appError}</div>
            }
...
export default connect(mapStateToProps, {addSmurf, submitError})(AddForm);
